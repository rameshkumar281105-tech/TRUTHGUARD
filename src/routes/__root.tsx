  ...
  head: () => ({
    meta: [
      ...
      { title: "TruthGuard AI — Real-Time Fake News Detection" },
      {
        name: "description",
        content:
          "Pre-publication misinformation analysis combining transformer text classification, image forensics and live evidence retrieval.",
      },
      { property: "og:title", content: "TruthGuard AI" },
      {
        property: "og:description",
        content: "Verify before you amplify — real-time, explainable fake news detection.",
      },
